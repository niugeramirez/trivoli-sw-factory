...
<table width="450" height="340" border="0" cellpadding="0" cellspacing="0" background="">
  <tr> 
	...
	<form name="FormVar" method="post">
		...
		<!--
		<img src="" border="0" usemap="#Map"> 
		-->
		<img align="right"    src="../shared/images/logo.jpg" border="0" usemap="#Map"> 
		<!--texto descriptivo en la barra sup-->
	    <div style="position:absolute; top:420px; left:260px;width:240px;">
			<input class="texto" style="text-align:center;color:black;width:240px;font-weight:bold;font-size:16px;" name="texto" readonly value="<%= l_titulo %>">
		</div>		
		<!--texto 1-->
	    <div style="position:absolute; top:456px; left:225px; width:100px;">
			<input class="texto" style="width:120px; color:black " readonly value="<%= l_texto1 %>">
		</div>
		<!--texto 2-->
	    <div style="position:absolute; top:483px; left:225px;width:100px;">
			<input class="texto" style="width:120px; color:black" readonly value="<%= l_texto2 %>">
		</div>
		<!--texto 3-->
	    <div style="position:absolute; top:510px; left:225px;width:100px;">
			<input id="texto3" class="texto" style="width:120px;" readonly value="<%= l_texto3 %>">
		</div>
		<!-- ayuda sup izquierda -->
		<div style="position:absolute; top:415px; left:90px;"> 											
        	<input name="titulo" class="blanc" style="border:none;color:white" readonly type="Text" align="absmiddle" size="40" border="0" >
		</div> 
		<!-- ayuda o errores -->
		<div style="position:absolute; top:425px; left:130px; width: 200px; height: 24px;"> 
        	<input name="desc" class="blanc" style="width:240px;border:none;" ReadOnly type="Text" align="absmiddle" size="40" border="0" value="">
		</div>
	<% If l_tipo <> "pass" then %>
		<div style="position:absolute; top:456px; left:350px; width: 150px; height: 22px;"> 
    	    <input name="usr2" class="blanc" type="Text" size="18" border="0"  onKeyPress="ok();" style="background-color:#FFFFFF;">
		</div>
        <div style="position:absolute;top:483px;left:350px; width: 150px"> 
	...
	<% End If %>
        <div style="position:absolute;top:535px;left:300px"> 

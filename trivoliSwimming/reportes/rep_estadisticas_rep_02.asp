...
case 6 'Obligaciones a pagar
	...
	l_sql = l_sql & " 		,sum(tab_agrup.pagado)		as pagado	 "
			l_sql = l_sql & " ,sum(tab_agrup.monto_compra)	- sum(tab_agrup.pagado)	 as	saldo "
	...
	l_sql = l_sql & " having sum(tab_agrup.monto_compra)	- sum(tab_agrup.pagado)	<> 0 "

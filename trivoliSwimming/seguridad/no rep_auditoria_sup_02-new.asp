...
<%
'--------------------------------------------------------------------------------------
'Archivo        : rep_auditoria_sup_02.asp
'Descripción    : Reporte - Auditoria EXCEL
'Autor          : CCRossi
'Fecha Creacion : 29-04-2004
'Modificado     
'--------------------------------------------------------------------------------------
const l_nro_col=8
...
sub encabezado%>
	...
	<tr>
		<td nowrap align="center"><b>Empresa</b></td>
...
do until l_rs.eof
	...
	l_linea = "<tr>"
	l_linea = l_linea &   "<td nowrap align=""center"">" &l_rs("estrdabr")& "</td>"
	...
	l_linea = l_linea &   "<td nowrap align=""right"">" & l_rs("acnro")& "</td>"	

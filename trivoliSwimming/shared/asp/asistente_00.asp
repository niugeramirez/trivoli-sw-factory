...
Autor: lisandro moro
Fecha: 23/07/2003
Modificado: lisandro moro - 03/02/2004 - redireccion de imagenes y estilos al ubicar el asistente en shared/asp 
-->
<% 
 Dim l_wiznro
 Dim l_sql
...
function ActPasos(codigo, clabel, nombre){
	//alert(codigo);
	document.pasos.location = "/trivoliSwimming/shared/asp/asistente_01.asp?wiznro=<%=l_wiznro%>&codigo="+codigo+"&label="+clabel+"&nombre="+nombre;
}
	...
	<tr>
    	<td align="left" class="barra" colspan="1" height="40" style="Navy; border-bottom: 1px solid White;"  nowrap>
		    <!--<img style="filter:Shadow(Color=White,Direction=120);" src="../images/gen_rep/tablero7.jpg">--><SPAN 
			    STYLE="position: absolute; top:12px; left:100px; font-size: 16px; color: White; font-family: Arial, Helvetica, sans-serif;">
				 &nbsp;Servicio Local de Promoción y Protección de Derechos del Niño , Niña y Adolescente</SPAN>

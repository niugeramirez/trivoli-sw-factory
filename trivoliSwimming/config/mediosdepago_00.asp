...
<body leftmargin="0" topmargin="0" rightmargin="0" bottommargin="0">
      <table border="0" cellpadding="0" cellspacing="0" height="100%" width="100%">
        <tr style="border-color :CadetBlue;">
          ...
          <%'eugenio 29/06/2015, unificacion de iconos call MostrarBoton ("sidebtnABM", "Javascript:abrirVentana('mediosdepago_02.asp?Tipo=A','',550,200);","Alta")%>
		  <a class="sidebtnABM" href="Javascript:abrirVentana('mediosdepago_02.asp?Tipo=A','',550,200);" ><img  src="/turnos/shared/images/Agregar_24.png" border="0" title="Alta">
		  &nbsp;          
          <%'eugenio 29/06/2015, unificacion de iconos call MostrarBoton ("sidebtnABM", "Javascript:abrirVentanaVerif('mediosdepago_02.asp?Tipo=M&cabnro=' + document.ifrm.datos.cabnro.value,'',550,200);","Modifica")%>
		  <a href="Javascript:abrirVentanaVerif('mediosdepago_02.asp?Tipo=M&cabnro=' + document.ifrm.datos.cabnro.value,'',550,200);"><img src="/turnos/shared/images/Modificar_16.png" border="0" title="Editar"></a>
        ...
        <tr valign="top" height="100%">
          <td colspan="2" style="" width="100%">
      	  <iframe name="ifrm" src="mediosdepago_01.asp" width="100%" height="100%"></iframe> 
	      </td>
        </tr>

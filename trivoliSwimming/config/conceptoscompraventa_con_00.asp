<% Option Explicit %>
<% 
'Archivo: bancos_con_00.asp
'Descripción: Administración de bancos
'Autor : Trivoli
'Fecha: 31/05/2015
...
<title>Administracion de Bancos</title>
...
function Submit_Formulario() {
	Validar_Formulario(	'dialog'								//id_dialog
						,'conceptoscompraventa_con_06.asp'					//url_valid_06
						,'conceptoscompraventa_con_03.asp'					//url_AM
...
$(document).ready(function() { 
								...
								inicializar_dialogConfirmDelete(	"dialogConfirmDelete"				//id_dialogConfirmDelete
																	,"conceptoscompraventa_con_04.asp"				//url_baja
																	,"dialogAlert"						//id_dialogAlert
...
function Buscar(){
	...
	window.ifrm.location = 'conceptoscompraventa_con_01.asp?asistente=0&filtro=' + $("#filtro_00").val();
}

function Limpiar(){
	window.ifrm.location = 'conceptoscompraventa_con_01.asp';
}
</script>
</head>
...
<body leftmargin="0" topmargin="0" rightmargin="0" bottommargin="0">
    <table border="0" cellpadding="0" cellspacing="0" height="100%" width="100%">
				...
				<table border="0" width="100%">
				    ...
				    <tr>
                        ...
                        <td align="center">
							...
							<a id="abrirAlta" class="sidebtnABM" href="Javascript:abrirDialogo('dialog','conceptoscompraventa_con_02.asp?Tipo=A',650,350)"><img  src="/trivoliSwimming/shared/images/Agregar_24.png" border="0" title="Agregar Articulo"></a>    
                        </td>
                    </tr>
					</tbody>
                </table>
		...
		<tr valign="top" height="100%">
            <td>
      	        <iframe id="ifrm" name="ifrm" src="conceptoscompraventa_con_01.asp" width="100%" height="100%"></iframe> 
	        </td>
        </tr>		
	</table>
	
		<!--	PARAMETRIZACION DE VENTANAS MODALES        -->				
		<div id="dialog" title="Articulos"> 			</div>	  

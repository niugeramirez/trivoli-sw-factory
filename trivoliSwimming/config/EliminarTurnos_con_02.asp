...
<form name="datos" action="EliminarTurnos_con_03.asp?tipo=<%= l_tipo %>" method="post" target="valida">
		...
		<table border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td>
					...
					<tr>
					    <td colspan="4" align="left"><b>¿Desea Eliminar el Turno del:&nbsp;<%= l_fechahorainicio %>&nbsp;?</b></td>

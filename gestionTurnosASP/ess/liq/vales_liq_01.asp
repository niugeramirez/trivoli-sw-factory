...
Modificacion   :
  ...
  Modificado  : 12/09/2006 Raul Chinestra - se agregó Vales en Autogestión   
                28/09/2006 Maximiliano Breglia - se saco v_empleado  
  				26/02/2007 - Martin Ferraro - Al dobleclick modificaba sin controlar si estaba liquidado.
-----------------------------------------------------------------------------
-->
<% 
'on error goto 0
...
<%else
	...
	ondblclick="Javascript:parent.Modificar();;">
		...
		<td align="center" width="10%"><% if l_rs("valrevis") = -1  then response.write "SI" else response.write "NO" end if %> </td>				

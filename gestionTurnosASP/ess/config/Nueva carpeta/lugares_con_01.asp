...
l_sql = "SELECT lugnro, lugcod, lugdes , locdes, prodes, lugzon"
...
<%else
	do until l_rs.eof
	%>
	    <tr ondblclick="Javascript:parent.abrirVentana('lugares_con_02.asp?cabnro=' + datos.cabnro.value,'',520,350)" onclick="Javascript:Seleccionar(this,<%= l_rs("lugnro")%>)">
	        <td width="5%" nowrap><%= l_rs("lugcod")%></td>
	        <td width="30%" nowrap><%= l_rs("lugdes")%></td>
			<td width="30%" nowrap><%= l_rs("locdes")%></td>
			<td width="30%" nowrap><%= l_rs("prodes")%></td>

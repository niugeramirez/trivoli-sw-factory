...
<body topmargin="0" leftmargin="0">
 <!--background="/ticket/shared/images/pi_gti.jpg"-->
...
'Set rs = Nothing
 %>
<iframe src="/ticket/shared/asp/timer.asp" width="90" height="30" scrolling="no" frameborder="0" style="visibility:hidden;"></iframe>
</div>

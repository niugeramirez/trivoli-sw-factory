...
<% 
'Archivo: asignar_embarque_con_08.asp
...
function DatosCamionero(){
	document.valida.location = "asignar_embarque_con_07.asp?camnro=" + document.datos.camnro.value ;	
}
...
<tr>
		<td align="left">
			...
			<%	l_sql = "SELECT tkt_camionero.camnro, camdes, camcod "
				...
				l_sql  = l_sql  & " INNER JOIN tkt_embarque ON tkt_embarque.ordnro = tkt_ord_cam.ordnro "

...
' Filtro
  l_etiquetas = "Código:;Producto:;Origen:;Destino:"
  l_Campos    = "ordcod;prodes;tkt_lugar.lugdes;lugard.lugdes"
  l_Tipos     = "T;T;T;T"

' Orden
  l_Orden     = "Código:;Producto:;Origen:;Destino:;Habilitado:;"
  l_CamposOr  = "ordcod;prodes;tkt_lugar.lugdes;deslugdes;ordhab"
...
function llamadaexcel(){ 
	if (filtro == "")
		...
		abrirVentana("ordenes_con_excel.asp?orden=" + document.ifrm.datos.orden.value + "&filtro=" + escape(document.ifrm.datos.filtro.value),'execl',250,150);
}
...
<body leftmargin="0" topmargin="0" rightmargin="0" bottommargin="0">
      <table border="0" cellpadding="0" cellspacing="0" height="100%" width="100%">
        <tr style="border-color :CadetBlue;">
          <td align="left" class="barra">Ordenes de trabajo</td>
          <td nowrap align="right" class="barra">
          <a class=sidebtnABM href="Javascript:abrirVentanaVerif('ordenes_con_02.asp?cabnro=' + document.ifrm.datos.cabnro.value,'',680,500);">Consulta</a>
		  &nbsp;&nbsp;
          <a class="sidebtnSHW" href="Javascript:llamadaexcel();">Excel</a>
		  &nbsp;&nbsp;
		  <a class=sidebtnSHW href="Javascript:orden('../../config/ordenes_con_01.asp');">Orden</a>
		  <a class=sidebtnSHW href="Javascript:filtro('../../config/ordenes_con_01.asp')">Filtro</a>
		  &nbsp;&nbsp;
        ...
        <tr valign="top" height="100%">
          <td colspan="2" style="" width="100%">
      	  <iframe name="ifrm" src="ordenes_con_01.asp" width="100%" height="100%"></iframe> 
	      </td>
        </tr>

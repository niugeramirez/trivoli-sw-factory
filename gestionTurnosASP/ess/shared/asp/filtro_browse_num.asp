...
'Modificado:
'	23/11/2004 - Alvaro Bayon - Limito la cantidad de números a ingresar en el filtro
...
function filtrar()
{
  ...
  if (document.datos.texto.value == ""){
    ...
    {
		//Convierto por si viene en notación científica
		document.datos.texto.value = parseFloat(document.datos.texto.value)
	  if (sel == "1")	
	    {

...
<%
'=================================================================================================
'Archivo		: carga_resultadosyarea_eva_00.asp
'Descripción	: Cargar competencias y resultado total por area
'Autor			: 24-09-2004
'Fecha			: CCRossi
'Modificado		: 24-11-2004 CCRossi caracteres raros en observaciones
'				: 03-03-2005 LAmadio - restringir la evaluacion de area la cargue solo el revisor 
'									 - modific. apariencia 
' 				: 07-03-2005 LAmadio - cambiar el fuente para que liste todas las areas y su respectivas competencias.
'				: 18-04-2005 LA. Modif para qur muestre resultados del evaluado y del revisor
...
if l_evatevnro <> cint(cevaluador) then
	...
	areaResu= areaResu & "<select name=areatrnro"& l_rs("evatitnro")&" style="" width:180 "">"
end if
...
if l_evatevnro <> evatevnro then
	...
	compResu = compResu & "<select name=evatrnro"&evafacnro&evatevnro&" style="" width:150 "">"
end if
...
<%'BUSCAR evaresultados para MODIFICAR resultados ----------------------------
   ...
   l_sql = l_sql & " LEFT JOIN evadetevldor  ON evadetevldor.evldrnro = evaresultado.evldrnro "
   l_sql = l_sql & " WHERE evaseccfactor.evaseccnro =" & l_evaseccnro

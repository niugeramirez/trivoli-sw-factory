...
<tr>
    <td align="right" class="th2">
		<a class=sidebtnABM href="Javascript:window.opener.ifrm.datos.orden.value=valor();window.opener.actualizarEmpleados();window.close();">Aceptar</a>

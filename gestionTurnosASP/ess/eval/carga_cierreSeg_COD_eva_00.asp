...
<% 
'=====================================================================================
'Archivo  : carga_cierreSeg_COD_eva_00.asp
...
<tr>
	...
	<td align=left>
		<input style="background : #e0e0de;" class="rev" type="text" name="evafecha" size="10" maxlength="10" value="<%=l_evafecha%>">
	</td>
</tr>
<tr>
	<td valign=top align=right colspan=2>
		<a href=# onclick="if (validarfecha(document.datos.evafecha)) {grabar.location='grabar_cierre_COD_eva_00.asp?evldrnro=<%=l_evldrnro%>&evaetapa=<%=l_evaetapa%>&evaobser='+escape(Blanquear(document.datos.evaobser.value))+'&evafecha='+document.datos.evafecha.value+'&evareunion='+document.datos.evareunion.value;document.datos.grabado.value='G';}">Grabar</a>

...
'Modificacion: 27-12-04-CCRossi-  sacar baja
'              26-09-2006- Gustavo Ring. Control cantidad máxima de caracteres.
...
function Controlar(objetiv,ponde,alcanza,texto){
	if (alcanza=="")
		alcanza.value=0;
	...
	if (objetiv.value.length>300)
	{
		alert('Los Objetivos no pueden superar los 300 caracteres.');
		texto.focus();
		return false;
	}	
	else
	...
	{
		alert('Las Observaciones no pueden superar los 300 caracteres.');
		texto.focus();
		return false;
	}	
	else

...
<!--
-------------------------------------------------------------------------------------
Archivo        : ag_puestos_emp_adp_mss_00.asp
Descripcion    : Muestra todos los puestos con los links asociados a las descripciones 
Autor          : Gustavo Ring
Fecha          : 26/07/2007
Modificación   :
-----------------------------------------------------------------------------
...
<body leftmargin="0" topmargin="0" rightmargin="0" bottommargin="0">
      <table border="0" cellpadding="0" cellspacing="0" height="95%">
        ...
        <tr valign="top" height="100%">
          <td colspan="4" style="">
      	  <iframe name="ifrm" src="ag_puestos_emp_mss_adp_01.asp?empleg=<%= l_empleg%>" width="100%" height="100%"></iframe> 		  
	      </td>
        </tr>
        <tr valign="top">

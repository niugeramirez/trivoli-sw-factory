...
<%else%>
	<%
	do until l_rs.eof%>
	<tr ondblclick="Javascript:parent.abrirVentanaVerif('requerimientos_eyp_02.asp?Tipo=M&ternro=' + document.datos.ternro.value+'&reqpernro='+document.datos.cabnro.value,'',600,580)" onclick="Javascript:Seleccionar(this,<%=l_rs("reqpernro")%>)">

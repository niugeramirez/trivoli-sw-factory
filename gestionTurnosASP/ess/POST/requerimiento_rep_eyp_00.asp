...
<!--
Archivo: requerimiento_rep_eyp_00.asp
Descripción: requerimientos reporta a
Autor : Lisandro Moro
Fecha: 20/04/2004
...
function Sig_Ant(leg){
	if (leg != ""){
		document.location ="requerimiento_rep_eyp_00.asp?empleg=" + leg;
	}
}
...
%>
<script>
	parent.document.datos.reqperrep.value = <%= l_ternro %>;
</script>
</body>
</html>

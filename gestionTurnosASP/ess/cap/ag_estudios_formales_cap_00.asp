...
<!--
-----------------------------------------------------------------------------
Archivo: estudios_formales_cap_00.asp
Descripcion: Estudios formales 
Autor: Lisandro Moro
Fecha: 16/01/2004
Modificado: Lisandro Moro -  06/02/2004  - Se agrego la seguridad a los botones
			Muzzolón M.   -  18/02/2004	 - Se agrego orden y filtro  
-----------------------------------------------------------------------------
-->
<% 
on error goto 0
...
<title> Estudios Formales - Capacitación - RHPro &reg;</title>
...
function ActualizarGap(){
	document.ifrm.location ="estudios_formales_cap_01.asp?ternro=" + document.datos.ternro.value;
}	

function ModGap(){
	//abrirVentanaVerif('estudios_informales_cap_02.asp?Tipo=M&cabnro=' + document.ifrm.datos.cabnro.value + '&ternro=' + document.datos.ternro.value,'',620,280)
	abrirVentanaVerif('ag_emp_est_formales_adp_02.asp?tipo=M&ternro='+ document.datos.ternro.value +'&nivnro='+document.ifrm.datos.nivnro.value+'&titnro='+document.ifrm.datos.titnro.value+'&instnro='+document.ifrm.datos.instnro.value+'&carredunro='+document.ifrm.datos.carredunro.value,'',550,304)
}	

function EliGap(){
	//eliminarRegistro(document.ifrm,'estudios_informales_cap_04.asp?cabnro=' + document.ifrm.datos.cabnro.value)
	eliminarRegistro(document.ifrm,'ag_emp_est_formales_adp_04.asp?ternro=' + document.datos.ternro.value+ '&nivnro=' + document.ifrm.datos.nivnro.value + '&titnro=' + document.ifrm.datos.titnro.value + '&instnro=' + document.ifrm.datos.instnro.value + '&carredunro=' + document.ifrm.datos.carredunro.value);
}	
	...
	<td colspan="2">
		<table border="0" cellpadding="0" cellspacing="0">
			<tr>
                ...
                <!--<a class=sidebtnABM href="Javascript:abrirVentana('estudios_informales_cap_02.asp?Tipo=A&ternro=' + document.datos.ternro.value,'',620,280)">Alta</a>-->

				<a class=sidebtnABM href="Javascript:abrirVentana('ag_emp_est_formales_adp_02.asp?tipo=A&ternro=<%= l_ternro %>','',550,350);">Alta</a>

				<a class=sidebtnABM href="Javascript:EliGap();">Baja</a>

				<a class=sidebtnABM href="Javascript:ModGap();">Modifica</a>
				
                <a class=sidebtnSHW href="Javascript:orden('../../adp/ag_emp_est_formales_adp_01.asp');">Orden</a>
		  														
				<a class=sidebtnSHW href="Javascript:filtro('../../adp/ag_emp_est_formales_adp_01.asp')">Filtro</a>
				</th>
			</tr>
		</table>
	</td>
	...
	<td colspan="2">
		<table  border="0" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td><input style="background : #e0e0de;" type="text" name="convenio" size="70" maxlength="50" value='<%= NombrePuesto %>' readonly></td>
...
<tr>
	<td colspan="2" height="90%">
		<table border="0" cellpadding="0" cellspacing="0"  height="100%">
	        <tr valign="top">
	        	<td align="left" style="">
    	  				<iframe  scrolling="Yes" name="ifrm" src="ag_emp_est_formales_adp_01.asp?ternro=<%= l_ternro %>" width="100%" height="100%"></iframe> 
     				</td>        				
      			</tr>
		</table>
	</td>

...
<!--
-----------------------------------------------------------------------------
Archivo		: con_eventos_en_competencia_cap_01.asp
Descripcion	: Consulta de Eventos en competencia
...
if l_rs.eof then%>
	<tr>
        <td colspan=6>No hay Eventos en que se contemple esa Competencia</td>
    </tr>
<%else
do until l_rs.eof
%>

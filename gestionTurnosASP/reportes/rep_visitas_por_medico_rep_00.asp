...
function Actualizar(destino){
	...
	if (destino== "exel")
		...
		document.ifrm.location = "rep_visitas_por_medico_rep_01.asp?" + param;			
			...
			<td align="center" colspan="2">
				<table border="0">
					...
					<tr>
						...
						<td  align="right" nowrap><b>Medico Derivador: </b></td>
						<td><select name="id" size="1" style="width:200;">
								<option value=0 selected>Todos los Medicos Derivadores</option>
								<%Set l_rs = Server.CreateObject("ADODB.RecordSet")
								l_sql = "SELECT  * "
								l_sql  = l_sql  & " FROM medicos_derivadores  "
								l_sql =  l_sql & " where medicos_derivadores.empnro = " & Session("empnro") 

...
Fecha: 23/07/2003
Modificado: 
	24-05-04 Alvaro Bayon - Variables para conservar orden y filtro en el asistente
-->
<% 
 Dim l_wiznro
 Dim l_sql
...
function ActPasos(codigo, clabel, nombre){
	document.pasos.location = "/serviciolocal/shared/asp/asistente1_01.asp?wiznro=<%=l_wiznro%>&codigo="+codigo+"&label="+clabel+"&nombre="+nombre;
}

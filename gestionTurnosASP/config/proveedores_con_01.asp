...
<% 
'Archivo: proveedores_con_01.asp
'Descripción: Grilla Administración de proveedores
'Autor : Trivoli
'Fecha: 31/05/2015
...
if l_orden = "" then
  l_orden = " ORDER BY proveedores.nombre "
end if
%>
...
<table>
    ...
    <tr>
	    <td colspan="4" >No existen Proveedores cargados para el filtro ingresado.</td>
    </tr>
    <%
    else
        l_primero = l_rs("id")
	    ...
	    do until l_rs.eof
		    l_cant = l_cant + 1
	    %>
	    <tr ondblclick="Javascript:parent.abrirDialogo('dialog','proveedores_con_02.asp?Tipo=M&cabnro=' + document.detalle_01.cabnro.value,650,350);" onclick="Javascript:parent.Seleccionar(this,<%= l_rs("id")%>,document.detalle_01.cabnro)">    

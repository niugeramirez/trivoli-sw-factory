...
l_agenro2 	  = request.querystring("qagenro")
...
function Actualizar(destino){
	...
	param = "qfecini=" + document.all.fecini.value + "&qfecfin=" + document.all.fecfin.value + "&qagenro=" + document.all.agenro.value;
	
	if (destino== "exel")
    	abrirVentana("rep_exp_buques_con_01.asp?" + param + "&excel=true",'execl',250,150);
	else
		document.ifrm.location = "rep_rem_ent_6_01.asp?" + param;			
...
<% End If %>
<form name="datos">
<input  type="hidden" name="agenro2" value="<%= l_agenro2 %>" >
<table border="0" cellpadding="0" cellspacing="0" height="100%">
	...
	<tr>
		...
		<td><select name="agenro" size="1" style="width:120;">
			...
			<script>document.datos.agenro.value= document.datos.agenro2.value </script>
			</td>	
	</tr>

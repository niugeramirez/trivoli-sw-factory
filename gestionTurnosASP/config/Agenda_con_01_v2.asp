...
Const URLDestino = "Agenda_con_02_v2.asp" 
		...
		<td colspan='7'>
			<table border='0' cellspacing='1' cellpadding='1' width='100%' class="calFondoEncabe">
				<tr>
					<td align='left'>					
						<%
						response.write "<a href = 'Agenda_con_01_v2.asp?filtro=" & l_filtro & "&id=" & l_id & "&hd="&l_hd & "&md="& l_md & "&hh="& l_hh & "&mh="& l_mh& "&"
						if MyMonth - 1 = 0 then 
	...
	For Col = 0 to 6
		...
		elseif CurrentDay > LastDay(MyMonth, MyYear) then
			...
			if l_referencia = "blanco" then
				...
				response.write "<a   target='ifrm2' href='" & URLDestino & "?id=" & l_id & "&fechadesde=" & CurrentDay & "/"& MyMonth & "/" & MyYear _
							& "&fechahasta=" & CurrentDay & "/" &  MyMonth & "/" & MyYear _
							& "&hd=" & l_hd & "&md=" & l_md & "&hh=" & l_hh & "&mh=" & l_mh _
							& "&filtro=" & l_filtro &  "'>" 
							
									'sta.value + "&hd="+document.datos.hd.value + "&md="+ document.datos.md.value + "&hh="+ document.datos.hh.value + "&mh="+ document.datos.mh.value + "&diassemana="+ DiasSemana + '&filtro=' + document.datos.filtro.value;
			end if
      ...
      <table border="0" cellpadding="0" cellspacing="0" height="100%" width="100%">
        ...
        <tr valign="top" height="100%">
          <td colspan="2" style="" width="100%">
      	  <iframe scrolling="yes" name="ifrm2" src="" width="100%" height="100%"></iframe> 
	      </td>
        </tr>		

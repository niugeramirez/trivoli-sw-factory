...
%>
	<table style="width:99%" cellpadding="0" cellspacing="0" border="0">
	    ...
	    <tr>
			...
			for x = 1 to l_indice_mercaderia - 1
			%>			  
			   <th align="center" style="border-top-color: #000000; border-top-style: solid; border-top-width: 1px; border-right-color: #000000; border-right-style: solid; border-right-width: 1px; border-bottom-color: #000000; border-bottom-style: solid; border-bottom-width: 1px; " ><%= ArrMerDes(x) %></th>
			<%
			next
			%>			  
			   <th align="center" style="border-top-color: #000000; border-top-style: solid; border-top-width: 1px; border-right-color: #000000; border-right-style: solid; border-right-width: 1px; border-bottom-color: #000000; border-bottom-style: solid; border-bottom-width: 1px; " >Toneladas</th>					
 		    </tr>	
<%
end sub
	...
	<table style="width:99%" cellpadding="0" cellspacing="0" border="0">
		<tr>
			<td align="center" colspan="20">
				<table>
					<tr>
				       	<td nowrap colspan="3"><%= l_Empresa_Aux %>
						</td>				
					</tr>				
					<tr>
				       	<td nowrap>&nbsp;
...
for x = 1 to l_indice_exportadora - 1
	...
	%>
	<tr>
		<td nowrap align="center" width="5%" style="border-right-color: #000000; border-right-style: solid; border-right-width: 1px; border-left-color: #000000; border-left-style: solid; border-left-width: 1px;" ><%= ArrExpDes(x) %></td>			
	<%
	l_TotMerExp = 0
	for y = 1 to l_indice_mercaderia - 1
		...
		%>
			<td align="right"  width="5%" style="border-right-color: #000000; border-right-style: solid; border-right-width: 1px; " ><%= MatMerExp(y,x) %></td>			
		<%
		end if 
	...
	%>
		<td align="right" width="5%" style="border-right-color: #000000; border-right-style: solid; border-right-width: 1px; "><%= l_TotMerExp %></td>			
	</tr>	
	<%
	l_nrolinea = l_nrolinea + 1
next
...
%>
	<tr>
		<td align="center" width="5%" style="border-top-color: #000000; border-top-style: solid; border-top-width: 1px; border-right-color: #000000; border-right-style: solid; border-right-width: 1px; border-bottom-color: #000000; border-bottom-style: solid; border-bottom-width: 1px; " >Total</td>			
<%
...
for i = 1 to l_indice_mercaderia - 1
	...
	%>	
	<td align="right"  width="5%" style="border-top-color: #000000; border-top-style: solid; border-top-width: 1px; border-right-color: #000000; border-right-style: solid; border-right-width: 1px; border-bottom-color: #000000; border-bottom-style: solid; border-bottom-width: 1px; "><% if l_TotMerExp = 0 then response.write "" else response.write l_TotMerExp end if  %></td>			
<%	
	l_TotTotMerExp = l_TotTotMerExp + l_TotMerExp
next
%>	
	<td  align="right" width="5%" style="border-top-color: #000000; border-top-style: solid; border-top-width: 1px; border-right-color: #000000; border-right-style: solid; border-right-width: 1px; border-bottom-color: #000000; border-bottom-style: solid; border-bottom-width: 1px; "><%= l_TotTotMerExp %></td>			
</tr>	
<%
response.write "</table><p style='page-break-before:always'></p>"
l_nropagina = l_nropagina + 1
...
for i = 1 to l_indice_mercaderia - 1
	...
	'---------------------fin mayor
%>	
	<td align="right"  width="7%" style="border-top-color: #000000; border-top-style: solid; border-top-width: 1px; border-right-color: #000000; border-right-style: solid; border-right-width: 1px; border-bottom-color: #000000; border-bottom-style: solid; border-bottom-width: 1px; "><% if l_TotMerExp = 0 then response.write "" else response.write l_TotMerExp end if  %></td>			
<%	
	l_TotTotMerExp = l_TotTotMerExp + l_TotMerExp
next
%>	
	<td  align="right" width="10%" style="border-top-color: #000000; border-top-style: solid; border-top-width: 1px; border-right-color: #000000; border-right-style: solid; border-right-width: 1px; border-bottom-color: #000000; border-bottom-style: solid; border-bottom-width: 1px; "><%= l_TotTotMerExp %></td>			
</tr>	
<%
response.write "</table><p style='page-break-before:always'></p>"
l_nropagina = l_nropagina + 1
...
'	end if
	%>
	<tr>
		<td nowrap align="center" width="10%" style="border-right-color: #000000; border-right-style: solid; border-right-width: 1px; border-left-color: #000000; border-left-style: solid; border-left-width: 1px;" ><%= ArrDesDes(x) %></td>			
	<%
	l_TotMerDes = 0
	for y = 1 to l_indice_mercaderia - 1
		...
		%>
			<td align="right"  width="5%" style="border-right-color: #000000; border-right-style: solid; border-right-width: 1px; " ><%= MatMerDes(y,x) %></td>			
		<%
		end if
	...
	%>
		<td align="right" width="5%" style="border-right-color: #000000; border-right-style: solid; border-right-width: 1px; "><%= l_TotMerDes %></td>			
	</tr>	
	<%
	l_nrolinea = l_nrolinea + 1	
next
...
for i = 1 to l_indice_mercaderia - 1
	...
	next
%>	
	<td align="right"  width="7%" style="border-top-color: #000000; border-top-style: solid; border-top-width: 1px; border-right-color: #000000; border-right-style: solid; border-right-width: 1px; border-bottom-color: #000000; border-bottom-style: solid; border-bottom-width: 1px; "><% if l_TotMerDes = 0 then response.write "" else response.write l_TotMerDes end if  %></td>			
<%	
	l_TotTotMerDes = l_TotTotMerDes + l_TotMerDes
next
%>	
	<td  align="right" width="10%" style="border-top-color: #000000; border-top-style: solid; border-top-width: 1px; border-right-color: #000000; border-right-style: solid; border-right-width: 1px; border-bottom-color: #000000; border-bottom-style: solid; border-bottom-width: 1px; "><%= l_TotTotMerDes %></td>			
</tr>	
<%
response.write "</table><p style='page-break-before:always'></p>"
l_nropagina = l_nropagina + 1
...
do while not l_rs.eof
	...
	encabezado_remimpexp("Removido, Importación y Exportación - Petroleo Crudo") 
	l_Empresa_Aux = ""
	'response.end
...
%>
<tr>
   <th align="center" colspan="6">Exportación CAS por Empresa</th>
</tr>
<tr>
...
<tr>
   ...
   <td align="center"><%= ran_empcas_nom1 %></td>					
   <td align="center"><%= ran_empcas_val1 %></td>					   
   
   <td align="center">1</td>					
   <td align="center"><%= ran_empcas_acu_nom1 %></td>					
   <td align="center"><%= ran_empcas_acu_val1 %></td>					   
</tr>
<tr>
   <td align="center">2</td>					
   <td align="center"><%= ran_empcas_nom2 %></td>					
   <td align="center"><%= ran_empcas_val2 %></td>					   
   <td align="center">2</td>					   
   <td align="center"><%= ran_empcas_acu_nom2 %></td>					
   <td align="center"><%= ran_empcas_acu_val2 %></td>					   
</tr>
<tr>
   <td align="center">3</td>					
   <td align="center"><%= ran_empcas_nom3 %></td>					
   <td align="center"><%= ran_empcas_val3 %></td>					   
   <td align="center">3</td>					   
   <td align="center"><%= ran_empcas_acu_nom3 %></td>					
   <td align="center"><%= ran_empcas_acu_val3 %></td>					   
</tr>

<tr>
   <th align="center" colspan="6">Exportación CAS por Producto</th>
</tr>
<tr>
   <th align="center" colspan="3" >Del Mes</th>					
   <th align="center" colspan="3">Del Año</th>
...
<tr>
   <td align="center">1</td>					
   <td align="center"><%= ran_mercas_nom1 %></td>					
   <td align="center"><%= ran_mercas_val1 %></td>					   
   
   <td align="center">1</td>					
   <td align="center"><%= ran_mercas_acu_nom1 %></td>					
   <td align="center"><%= ran_mercas_acu_val1 %></td>					   
</tr>
<tr>
   <td align="center">2</td>					
   <td align="center"><%= ran_mercas_nom2 %></td>					
   <td align="center"><%= ran_mercas_val2 %></td>					   
   
   <td align="center">2</td>					
   <td align="center"><%= ran_mercas_acu_nom2 %></td>					
   <td align="center"><%= ran_mercas_acu_val2 %></td>					   
</tr>
<tr>
   <td align="center">3</td>					
   <td align="center"><%= ran_mercas_nom3 %></td>					
   <td align="center"><%= ran_mercas_val3 %></td>					   
   
   <td align="center">3</td>					
   <td align="center"><%= ran_mercas_acu_nom3 %></td>					
   <td align="center"><%= ran_mercas_acu_val3 %></td>					   
</tr>
<tr>

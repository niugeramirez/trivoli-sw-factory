...
/*
	...
	*/
	...
	if (estado == "si"){
		window.ifrm.location = 'Agenda_con_01_v2.asp?hd='+document.datos.hd.value + "&md="+ document.datos.md.value + "&hh="+ document.datos.hh.value + "&mh="+ document.datos.mh.value+ '&filtro=' + document.datos.filtro.value;
	    //window.ifrm.location = 'TransferirTurnos_con_00.asp?hd='+document.datos.hd.value + "&md="+ document.datos.md.value + "&hh="+ document.datos.hh.value + "&mh="+ document.datos.mh.value+ '&filtro=' + document.datos.filtro.value;		
	}
}

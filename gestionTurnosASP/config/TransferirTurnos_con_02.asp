...
<form name="datos" action="TransferirTurnos_con_03.asp?tipo=<%= l_tipo %>" method="post" target="valida">
<input type="hidden" name="ant" value="<%= l_ant %>">
<input type="hidden" name="nuevo" value="<%= l_nuevo %>">
		...
		<table border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td>
					...
					<tr>
					    <td colspan="4" align="left"><b>¿Desea Transferir el Turno al:&nbsp;<%= l_fechahorainicio %>&nbsp;?</b></td>

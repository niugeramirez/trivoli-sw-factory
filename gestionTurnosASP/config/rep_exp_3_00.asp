...
l_desnro2 	  = request.querystring("qdesnro")
...
function Actualizar(destino){
	...
	param = "qfecini=" + document.all.fecini.value + "&qfecfin=" + document.all.fecfin.value + "&qdesnro=" + document.all.desnro.value;
	
	if (destino== "exel")
    	abrirVentana("rep_exp_buques_con_01.asp?" + param + "&excel=true",'execl',250,150);
	else
		document.ifrm.location = "rep_exp_3_01.asp?" + param;			
...
<% End If %>
<form name="datos">
<input  type="hidden" name="desnro2" value="<%= l_desnro2 %>" >
<table border="0" cellpadding="0" cellspacing="0" height="100%">
	...
	<tr>
		...
		<td><select name="desnro" size="1" style="width:120;">
			...
			<script>document.datos.desnro.value= document.datos.desnro2.value </script>
			</td>	
	</tr>

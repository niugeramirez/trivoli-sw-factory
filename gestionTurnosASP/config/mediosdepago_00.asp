...
<body leftmargin="0" topmargin="0" rightmargin="0" bottommargin="0">
      <table border="0" cellpadding="0" cellspacing="0" height="100%" width="100%">
        <tr style="border-color :CadetBlue;">
          ...
          <% call MostrarBoton ("sidebtnABM", "Javascript:abrirVentana('mediosdepago_02.asp?Tipo=A','',550,200);","Alta")%>&nbsp;
          ...
          <% call MostrarBoton ("sidebtnABM", "Javascript:abrirVentanaVerif('mediosdepago_02.asp?Tipo=M&cabnro=' + document.ifrm.datos.cabnro.value,'',550,200);","Modifica")%>
		  &nbsp;&nbsp;

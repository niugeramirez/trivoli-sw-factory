...
function Buscar(){
	...
	if (estado == "si"){
		window.ifrm.location = 'legajos_con_01.asp?asistente=0&filtro=' + document.datos.filtro.value;
	}
}
      ...
      <table border="0" cellpadding="0" cellspacing="0" height="100%" width="100%">
        ...
        <tr valign="top" height="100%">
          <td colspan="2" style="" width="100%">
      	  <iframe scrolling="yes" name="ifrm" src="legajos_con_01.asp" width="100%" height="100%"></iframe> 
	      </td>
        </tr>		
			</form>		
      </table>

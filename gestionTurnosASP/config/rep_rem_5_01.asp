...
l_expnro      = request.querystring("qexpnro")
...
sub encabezado_Exportadora(titulo)

Dim l_nombre_exportadora

l_sql = " SELECT buq_exportadora.expdes "
l_sql = l_sql & " FROM buq_exportadora  "
l_sql = l_sql & " WHERE buq_exportadora.expnro = " & l_expnro
rsOpen l_rs, cn, l_sql, 0
if not l_Rs.eof then
	l_nombre_exportadora = l_rs(0)
else
	l_nombre_exportadora = "Todos"
end if 
l_rs.close
		...
		<tr>
			<td align="center" colspan="14">
				<table cellpadding="0" cellspacing="0">
					<tr>
						<td align="left" width="100%" colspan="7">
							<b>Exportadora: <%= 	l_nombre_exportadora %></b>&nbsp;&nbsp;&nbsp;<%= l_fecini %> &nbsp;-&nbsp;<%= l_fecfin %>
						</td>
				       	<td align="right" nowrap width="5%" > 
							<!--P&aacute;gina: <%'= l_nropagina%> -->
						</td>				
...
if l_expnro <> "" then
	l_sql = l_sql & "  AND buq_contenido.expnro = " & l_expnro
end if

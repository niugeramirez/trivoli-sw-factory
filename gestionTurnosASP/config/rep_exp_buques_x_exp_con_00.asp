...
<title><%= Session("Titulo")%> Buques por Exportadora </title>
...
function Actualizar(destino){
	...
	param = "qfecini=" + document.all.fecini.value + "&qfecfin=" + document.all.fecfin.value + "&expnro=" + document.all.expnro.value;
	
	if (destino== "exel")
    	abrirVentana("rep_exp_buques_con_01.asp?" + param + "&excel=true",'execl',250,150);
	else
		document.ifrm.location = "rep_exp_buques_x_exp_con_01.asp?" + param;			

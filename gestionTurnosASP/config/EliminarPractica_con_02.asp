...
<form name="datos" action="EliminarPractica_con_03.asp?tipo=<%= l_tipo %>" method="post" target="valida">
<input type="hidden" name="idpractica" value="<%= l_idpractica %>">
		...
		<table border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td>
					...
					<tr>
					    <td colspan="4" align="left"><b>¿Desea Eliminar la Practica:&nbsp;<%'= l_fechahorainicio %>&nbsp;?</b></td>

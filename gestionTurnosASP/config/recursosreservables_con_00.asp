...
function Buscar(){
	...
	if (document.datos.legape.value != 0){
		if (tieneotro == "si"){
			document.datos.filtro.value += " AND recursosreservables.descripcion like '*" + document.datos.legape.value + "*'";
		}else{
			document.datos.filtro.value += " recursosreservables.descripcion like '*" + document.datos.legape.value + "*'";
		}
		tieneotro = "si";
	}		
	/*		
...
<body leftmargin="0" topmargin="0" rightmargin="0" bottommargin="0" onload="Javascript:document.datos.fechadesde.focus();">
      <table border="0" cellpadding="0" cellspacing="0" height="100%" width="100%">
        <tr style="border-color :CadetBlue;">
          ...
          <% call MostrarBoton ("opcionbtn", "Javascript:abrirVentana('recursosreservables_con_02.asp?Tipo=A','',650,250);","Alta")%>
		  &nbsp;&nbsp;
          <% call MostrarBoton ("opcionbtn", "Javascript:eliminarRegistro(document.ifrm,'recursosreservables_con_04.asp?cabnro=' + document.ifrm.datos.cabnro.value);","Baja")%>
		  &nbsp;&nbsp;
			...
			<td align="center" colspan="2">
				<table border="0">
					...
					<tr>
						...
						<td colspan="3"><input  type="text" name="legape" size="21" maxlength="21" value="" >
						</td>
						<!--

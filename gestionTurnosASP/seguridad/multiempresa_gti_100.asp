...
'l_filtro = Server.UrlEncode(l_filtro)
...
<tr>
    <td align="right" class="th2">
		<a class=sidebtnABM href="Javascript:window.opener.ifrm.location = '<%= l_destino %>?orden=' + valor() + '&filtro=' + escape(document.datos.filtro.value); window.close();">Aceptar</a>

...
</a> <a id="" class="sidebtnABM" href="Javascript:logout(1);window.location= 'lanzador2M.asp'//window.history.back();" style="position:absolute; left: 237px; top: 290px;">Salir</a> 


  <area shape="circle" coords="387,314,19" href="#" onClick="Javascript:logout(1);window.location= 'lanzador2M.asp'//window.history.back();"  onMouseOver="tip('Volver');" onMouseOut="tip('');">

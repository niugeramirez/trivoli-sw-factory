...
<%else
	do until l_rs.eof
	%>
	    <tr ondblclick="Javascript:parent.abrirVentana('tipo_buques_con_02.asp?Tipo=M&cabnro=' + datos.cabnro.value,'',520,200)" onclick="Javascript:Seleccionar(this,<%= l_rs("tipbuqnro")%>)">
	        <td width="15%" align="center" nowrap><%= l_rs("tipbuqnro")%></td>
	        <td width="85%" nowrap><%= l_rs("tipbuqdes")%></td>			
	    </tr>
	<%
		l_rs.MoveNext
	loop

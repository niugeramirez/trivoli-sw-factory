...
<%
	...
	i = 0
	l_mayor = 0
	ReDim arrData(UBound(l_lista),2)
	...
	do while i <= UBound(l_lista)-1
		...
		if cdbl(l_elem(1)) > cdbl(l_mayor) then
			l_mayor = l_elem(1)
		end if
...
'		Call renderChart("../../FusionCharts/FCF_Column3D.swf", "", strXML, "productSales", 600, 400)
		Call renderChart("../FusionCharts/FCF_Doughnut2D.swf", "", strXML, "productSales", 400, 200)

...
l_agenro      = request.querystring("qagenro")
...
sub encabezado_Agencia(titulo)

Dim l_nombre_agencia

l_sql = " SELECT buq_agencia.agedes "
l_sql = l_sql & " FROM buq_agencia  "
l_sql = l_sql & " WHERE buq_agencia.agenro = " & l_agenro
rsOpen l_rs, cn, l_sql, 0
if not l_Rs.eof then
	l_nombre_agencia = l_rs(0)
else
	l_nombre_agencia = "Todos"
end if 
l_rs.close
		...
		<tr>
			<td align="center" colspan="14">
				<table cellpadding="0" cellspacing="0">
					<tr>
						<td align="left" width="100%" colspan="7">
							<b>Agencia: <%=	l_nombre_agencia %></b>&nbsp;&nbsp;&nbsp;<%= l_fecini %> &nbsp;-&nbsp;<%= l_fecfin %>
						</td>
				       	<td align="right" nowrap width="5%" > 
							<!--P&aacute;gina: <%'= l_nropagina%> -->
						</td>				
...
if l_agenro <> "" then
	l_sql = l_sql & "  AND buq_buque.agenro = " & l_agenro
end if

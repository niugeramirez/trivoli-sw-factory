...
Response.write "<script>alert('Operación Realizada.');window.parent.opener.opener.parent.ifrm.location.reload();window.parent.opener.ifrm.location.reload();window.parent.close();</script>"
%>

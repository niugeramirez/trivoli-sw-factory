...
<body leftmargin="0" topmargin="0" rightmargin="0" bottommargin="0">
      <table border="0" cellpadding="0" cellspacing="0" height="100%" width="100%">
        <tr style="border-color :CadetBlue;">
          <td align="left" class="barra">Agencias</td>
          <td nowrap align="right" class="barra">
          <% call MostrarBoton ("sidebtnABM", "Javascript:abrirVentana('agencias_con_02.asp?Tipo=A','',520,200);","Alta")%>
          <% call MostrarBoton ("sidebtnABM", "Javascript:eliminarRegistro(document.ifrm,'agencias_con_04.asp?cabnro=' + document.ifrm.datos.cabnro.value);","Baja")%>
          <% call MostrarBoton ("sidebtnABM", "Javascript:abrirVentanaVerif('agencias_con_02.asp?Tipo=M&cabnro=' + document.ifrm.datos.cabnro.value,'',520,200);","Modifica")%>
		  &nbsp;&nbsp;
        ...
        <tr valign="top" height="100%">
          <td colspan="2" style="" width="100%">
      	  <iframe scrolling="Yes" name="ifrm" src="agencias_con_01.asp" width="100%" height="100%"></iframe> 
	      </td>
        </tr>		
      </table>
</body>

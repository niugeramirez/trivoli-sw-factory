...
function Buscar(){
	...
	*/
	if (estado == "si"){
		window.ifrm.location = 'AsignarCalendario_con_03.asp?asistente=0&filtro=' + document.datos.filtro.value;
	}
}
					...
					<tr>
						...
						<td><select name="id" size="1" style="width:200;">
							...
							<script>document.datos.id.value= "0"</script>
										...
										<td ><a class="sidebtnABM" href="Javascript:Buscar();" ><img  src="/serviciolocal/shared/images/find_48.png" border="0" alt="Buscar"></a></td>

...
function Buscar(){
	...
	*/
	if (estado == "si"){
		window.ifrm.location = 'transferirturnos_con_01.asp?cabnro=' + document.datos.cabnro.value +'&filtro=' + document.datos.filtro.value;
	}
}
				...
				<table border="0">
					...
					<tr>
						...
						<td><select name="id" size="1" style="width:200;">
								<option value=0 selected>Todos los M&eacute;dicos</option>

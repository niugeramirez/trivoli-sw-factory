...
%>
	<table style="width:99%" cellpadding="0" cellspacing="0" border="0">
		...
		l_sql = l_sql & " AND buq_buque.tipopenro = 1 "
...
%>
	<table style="width:99%" cellpadding="0" cellspacing="0" border="0">
	    ...
	    <tr>
			...
			<th align="center" width="10%" style="border-top-color: #000000; border-top-style: solid; border-top-width: 1px; border-right-color: #000000; border-right-style: solid; border-right-width: 1px;border-bottom-color: #000000; border-bottom-style: solid; border-bottom-width: 1px; border-left-color: #000000; border-left-style: solid; border-left-width: 1px;"	>Operación</th>					
	    </tr>		
<%
end sub 'encabezado
...
function Buque(buqdes){
	...
	param = "qfecini=<%= l_fecini %>&qfecfin=<%= l_fecfin %>&qbuqdes=" + buqdes ;
   	...
   	abrirVentana("rep_rem_detalle_buques_03.asp?" + param ,'',780,580);	
...
'l_nropagina = 1
encabezado_cabmarcar("Removido Salida (Cargas) - Detalle de Buques") 
l_nrolinea = 6
...
l_sql = l_sql & " WHERE  ( buq_buque.tipopenro = 1 ) "
l_sql = l_sql & " AND  buq_buque.buqfechas >= " & cambiafecha(l_fecini,"YMD",true) 
l_sql = l_sql & " AND buq_buque.buqfechas <= " & cambiafecha(l_fecfin,"YMD",true)
...
do until l_rs.eof
		...
		<tr>
			...
			<td align="center" width="10%" style="border-right-color: #000000; border-right-style: solid; border-right-width: 1px; "><% if l_rs("tipopenro") = 1 then response.write "Carga" else response.write "Descarga" end if %></td>
	    </tr>
		<%

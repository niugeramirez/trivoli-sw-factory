...
l_desnro      = request.querystring("qdesnro")
...
sub encabezado_destino(titulo)

Dim l_nombre_destino

l_sql = " SELECT buq_destino.desdes "
l_sql = l_sql & " FROM buq_destino  "
l_sql = l_sql & " WHERE buq_destino.desnro = " & l_desnro
rsOpen l_rs, cn, l_sql, 0
if not l_Rs.eof then
	l_nombre_destino = l_rs(0)
else
	l_nombre_destino = "Todos"
end if 
l_rs.close
		...
		<tr>
			<td align="center" colspan="14">
				<table cellpadding="0" cellspacing="0">
					<tr>
						<td align="left" width="100%" colspan="7">
							<b>Destino: <%= 	l_nombre_destino %></b>&nbsp;&nbsp;&nbsp;<%= l_fecini %> &nbsp;-&nbsp;<%= l_fecfin %>
						</td>
				       	<td align="right" nowrap width="5%" > 
							<!--P&aacute;gina: <%'= l_nropagina%> -->
						</td>				
...
if l_desnro <> "" then
	l_sql = l_sql & "  AND buq_contenido.desnro = " & l_desnro
end if

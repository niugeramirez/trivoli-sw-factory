		...
		<tr>
			<td align="center" colspan="14">
				<table cellpadding="0" cellspacing="0">
					<tr>
						<td align="left" width="100%" colspan="7">
							<b>Producto: <%= l_nombre_mercaderia %></b>&nbsp;&nbsp;&nbsp;<%= l_fecini %> &nbsp;-&nbsp;<%= l_fecfin %>  &nbsp;-&nbsp;<%= titulo %>
						</td>
				       	<td align="right" nowrap width="5%" > 
							<!--P&aacute;gina: <%'= l_nropagina%> -->
						</td>				
...
response.write l_mernro
'response.end

l_sql = " SELECT buq_mercaderia.merdes, buq_mercaderia.mernro "
l_sql = l_sql & " FROM buq_mercaderia  "
l_sql = l_sql & " WHERE buq_mercaderia.tipmerdes = 'CAS'  "
l_sql = l_sql & " AND ( " & l_mernro  & " = 0 OR  buq_mercaderia.mernro = " & l_mernro & " ) "
l_sql = l_sql & " ORDER BY buq_mercaderia.merord "

rsOpen l_rs3, cn, l_sql, 0
do while not l_Rs3.eof

l_mernro = l_Rs3("mernro")
...
if l_rs.eof then
	'encabezado_mercaderia(" - Sin Movimientos - ")
	l_rs.close
else
...
%>
	<tr>
		<th align="center" width="150" style="border-right-color: #000000; border-right-style: solid; border-right-width: 1px; ">Destino</th>

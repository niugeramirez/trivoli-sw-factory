...
<%
   ...
   strDataCurr = "<dataset seriesName='P.Ciguena' color='AFD8F8' >"
   strDataPrev = "<dataset seriesName='P.Ancla' color='F6BD0F' >"
...
'		Call renderChart("../../FusionCharts/FCF_Column3D.swf", "", strXML, "productSales", 600, 400)
		Call renderChart("../FusionCharts/FCF_MSColumn3D.swf", "", strXML, "productSales", 700, 350)

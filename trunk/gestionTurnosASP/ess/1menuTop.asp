...
<body class="indexprincipal" onLoad="if (parent.ajustarIframe) parent.ajustarIframe(window);">
...
'			l_rs.close
		...
		<tr>
			<td class="tdprincipal">
				...
				<iframe name="principal" id="principal" src="1<%= l_accion%>" frameborder="0" scrolling="yes"></iframe>
			</td>
		</tr>
	</table>
</body>

...
Modificacion   :
  ...
  17/01/2005 - CCRossi.  - Agegar paramnetro llamadora y si viene de EVA que ejecute funcion
...
//    obtenerTerceros();
	...
	<%if trim(l_llamadora)="GAP" then%>	
		opener.actualizarEmpleados();
	<%end if%>	
	
	<%if trim(l_llamadora)="EVA" then%>	
		opener.actualizarEmpleados();
	<%end if%>	
  ...
  <table style="width:550px;border-color:gray ; border-width: 1 ; border-style:solid ; margin-top: 5px;">
    <tr>
	  <td align="center">
         ...
         <iframe class="iframefiltros" frameborder="1" name="ifrmfiltros" src="gen_select_emp_v2_01.asp?seltipnro=<%= l_seltipnro%>" width="98%" height="100" scroll=no></iframe><br>
...
<tr>
  <td valign="top" align="center">
    <iframe class="iframelista" align="center" name="nselfil" width="<%= l_selancho%>" height="<%= l_selalto%>" src="blanc.asp" scroll=no></iframe>   
	<br>
  ...
  <td valign="top" align="center">
    <iframe class="iframelista" align="center" name="selfil" width="<%= l_selancho%>" height="<%= l_selalto%>" src="blanc.asp"></iframe>   
	<br>
...
<iframe  src="blanc.asp" class="iframevacio" name="valida" width="0" height="0"></iframe>

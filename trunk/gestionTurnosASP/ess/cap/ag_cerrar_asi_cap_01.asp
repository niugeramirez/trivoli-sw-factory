...
<table>
    <tr align="center" > 
		<th colspan="6">Participantes que No alcanzan el % de Asistencia Requerido</th>
    </tr>
    <tr>
		<th>Legajo</th>
        <th>Apellido</th>
...
<%else
	...
	%>
	    <tr>
	        <td width="20%" align="left"><%= l_rs("empleg")%></td>
	        <td width="40%" align="left"><%= l_rs("terape")%></td>
	        <td width="40%" nowrap><%= l_rs("ternom")%></td>
	        <td width="10%" nowrap align="center"><%= Round(l_tot / 60 ,2) %></td>			
	        <td width="10%" nowrap align="center"><%= Round(l_can / 60 ,2)%></td>			

...
<table height="100%" width="100%" cellpadding="0" cellspacing="0">
   ...
   <tr valign="top" height="50%">
         <td colspan="2" style="" align="center">
     	  <iframe  scrolling="Yes" name="ifrm" frameborder="0" src="ag_cerrar_mod_cap_00.asp?evenro= <%= l_evenro %> " width="100%" height="100%"></iframe> 		  		       	
      </td>
   </tr>
    <tr valign="top" height="50%">
         <td colspan="2" style="" align="center">
     	  <iframe  scrolling="Yes" name="ifrm1" frameborder="0" src="ag_cerrar_dic_cap_00.asp?evenro= <%= l_evenro %> " width="100%" height="100%"></iframe> 
      </td>
    </tr>		
</table>

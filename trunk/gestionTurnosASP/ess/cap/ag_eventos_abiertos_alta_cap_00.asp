...
<tr>
	<td colspan="2" height="100%">
		<table border="0" cellpadding="0" cellspacing="0"  height="100%">
<!--			<tr>
				<td class="th2">Eventos Abiertos en los que está inscripto</td>
	        ...
	        <tr valign="top">
	        	<td align="left" style="" height="50%" nowrap  colspan="2">
   	  				<iframe  scrolling="Yes" name="ifrm2" src="ag_eventos_abiertos_cap_01.asp?ternro=<%= l_ternro %>" width="100%" height="100%"></iframe> 
   				</td>        				
   			</tr>-->
			<tr>
				<th>Listado de Eventos Abiertos</th>
				<th align="right">
	        ...
	        <tr valign="top">
	        	<td align="left" style="" height="100%" colspan="2">
   	  				<iframe  scrolling="Yes" name="ifrm" src="ag_eventos_abiertos_cap_02.asp?ternro=<%= l_ternro %>" width="100%" height="100%"></iframe>
					<!--<iframe  scrolling="Yes" name="ifrm" src="ag_eventos_cerrados_cap_01.asp?ternro=<%'= l_ternro %>" width="100%" height="100%"></iframe>-->
   				</td>        				
   			</tr>
		</table>
	</td>

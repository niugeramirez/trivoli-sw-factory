...
<!--
-----------------------------------------------------------------------------
Archivo		: ag_eventos_abiertos_cap_00.asp
...
<tr>
	<td colspan="2" height="100%">
		<table border="0" cellpadding="0" cellspacing="0"  height="100%" width="100%">
			<tr>
				<th>Eventos Abiertos en los que está inscripto</th>
				<th align="right">
	        ...
	        <tr valign="top">
	        	<td align="left" style="" height="50%" nowrap  colspan="2">
   	  				<iframe  scrolling="Yes" name="ifrm2" src="ag_eventos_abiertos_cap_01.asp?ternro=<%= l_ternro %>"></iframe> 
   				</td>        				
   			</tr>
			<tr>
				<th>Eventos Cerrados en los que está inscripto</th>
				<!--<td class="th2">Listado de Eventos Abiertos</td>-->
				<th align="right">
					...
					<a class=sidebtnABM href="Javascript:Javascript:quitar2();">Quitar del Evento</a>	
				</th>
			</tr>
	        <tr valign="top">
	        	<td align="left" style="" height="50%" colspan="2">
   	  				<!--<iframe  scrolling="Yes" name="ifrm" src="ag_eventos_abiertos_cap_02.asp?ternro=<%'= l_ternro %>" width="100%" height="100%"></iframe>--> 
					<iframe  scrolling="Yes" name="ifrm" src="ag_eventos_cerrados_cap_01.asp?ternro=<%= l_ternro %>" ></iframe>
   				</td>        				
   			</tr>
		</table>
	</td>

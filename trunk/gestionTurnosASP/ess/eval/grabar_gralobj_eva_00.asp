...
<% 
'=====================================================================================
'Archivo  : grabar_gralobj_eva_00.asp
'Objetivo : grabar calificacion gral de objetivos de evaluacion
'Fecha	  : 03-01-2005
'Autor	  : CCRossi
'=====================================================================================
...
if  l_rs1.eof then
	l_sql= "insert into evagralobj (evldrnro,evatrnro) "
	l_sql = l_sql & " values (" & l_evldrnro & "," & l_evatrnro  &")"
else
	l_sql = "UPDATE evagralobj SET "

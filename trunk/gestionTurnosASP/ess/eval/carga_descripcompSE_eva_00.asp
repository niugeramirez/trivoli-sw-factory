...
<% 
'=====================================================================================
'Archivo  : carga_descripcompSE_eva_00.asp
...
' response.write l_sql
'if cint(evatevnro) = cint(cautoevaluador) then 
	
	descComp = "<input type=""Text"" name=""resudesc"&evafacnro&l_evldrnroComp &""" value="""& descrip&""" size=""60"" maxlength=""150"">"
	compGrabar = " <a href=# onclick=""if (ControlarTexto(document.datos.resudesc"&evafacnro&l_evldrnroComp &")) "
	compGrabar = compGrabar & "{ grabar.location='grabar_competencias_descripcion_00.asp?evafacnro="&evafacnro&"&evldrnro="&l_evldrnroComp 
	compGrabar = compGrabar & "&evaresudesc='+escape(Blanquear(document.datos.resudesc"&evafacnro&l_evldrnroComp &".value))+'&campo=resudesc"&evafacnro&l_evldrnroComp &"'"
	compGrabar = compGrabar & ";document.datos.grabadoresu"&evafacnro&l_evldrnroComp &".value='G'; }"">Grabar</a>"
...
'else 
	'descComp= "<input type=""Text"" name=""resudesc"" value="""& descrip&""" size=""60"" maxlength=""150"" disabled>"
	'compGrabar =
'end if 

'compDescrip = "	<input type=hidden name=evaresudesc"&evafacnro&evldrnro&">"     <input width=""  size=""

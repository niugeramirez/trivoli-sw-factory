...
l_otros   = Request.querystring("otros")
...
<title>Orden - Gesti&oacute;n de Desempe&ntilde;o - RHPro &reg;</title>
</head>
<script>
function valor()
{
...
<input type="Hidden" name="otros" value="<%= l_otros %>">
<table cellspacing="1" cellpadding="0" border="0" width="100%">
  <tr>
    <td class="th2" colspan="3">Órden</td>
  </tr>
  <tr>
    <td class="th2">&nbsp;</td>
...
<tr>
    <td align="right" class="th2">
		<a class=sidebtnABM href="Javascript:window.opener.ifrm.location = '<%= l_destino %>?orden=' + valor() + '&filtro=' + escape(document.datos.filtro.value) +'&otros='+document.datos.otros.value; window.close();">Aceptar</a>

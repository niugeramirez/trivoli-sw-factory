...
<%
'================================================================================
'Archivo		: ver_calificompSI_eva_00.asp
'Descripción	: Visto de competencias y areas para varios evaluadores
'Autor			: 02-09-2005
...
' __________________________________________________________________________
sub descripComp (evafacnro, evacabnro ,descComp, descrip)
descrip=""
...
<iframe name="terminarsecc" src="termsecc_areasyresultadosSE_eva_00.asp?tipo=eval&evacabnro=<%=l_evacabnro%>&evaseccnro=<%=l_evaseccnro%>&evldrnro=<%=l_evldrnro%>&evatevnro=<%=l_evatevnro%>" style="visibility:hidden;width:0;height:0">
</iframe>
</form>	
</body>
</html>

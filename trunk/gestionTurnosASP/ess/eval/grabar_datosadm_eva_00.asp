...
<% 
'--------------------------------------------------------------------------
'Archivo       : grabar_datosadm_eva_00.asp
...
if trim(l_fechareunion) <> "" then
	l_fechareunion = cambiafecha(l_fechareunion,"YMD",false)
else
	l_fechareunion = "NULL"
end if
...
if l_tipo="M" then
	...
	do while not l_rs.EOF 
		...
		l_sql = l_sql & " horas = " & l_horas & ","
		l_sql = l_sql & " fechareunion = " & l_fechareunion & ","
	...
	l_sql = l_sql &  		 "," & l_fechareunion & "," & l_basereunion & ")"

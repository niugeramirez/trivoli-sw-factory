...
<%
'================================================================================
'Archivo		: carga_calificobjRDP_eva_00.asp
...
if l_cantproysaprob > 0  then ' al menos hay RDE aprobada 
	objResu= objResu & "<select name=""evatrnro"">" 
else 
...
%>
		<tr>
			<td><%= l_rs("evaevenro")%></td> <!-- l_rs("evaproynro") -->
...
<%  	l_rs1.Close
   ...
   <tr height="20">
	 	<td colspan="8" align="center"> No existen proyectos asociados a el per&iacute;odo con RDE's cerradas.</td>
   </tr>
<%
end if

...
'Descripción	: vista de  competencias y areas para varios evaluadores
'Autor			: 29-08-2005
...
<iframe name="terminarsecc" src="termsecc_areasyresultadosSI_eva_00.asp?evacabnro=<%=l_evacabnro%>&evaseccnro=<%=l_evaseccnro%>&evldrnro=<%=l_evldrnro%>&evatevnro=<%=l_evatevnro%>" style="visibility:hidden;width:0;height:0">
</iframe>
</form>	
</body>
</html>

...
<% 
'================================================================================
'Archivo		: buscar_supervisor_eva.asp
'Descripción	: Devuelve el ternro del revisor del revisor
'Autor			: CCRossi
'Fecha			: 14-12-2004
'Modificado		:
'================================================================================
...
l_sql = "SELECT super.ternro "
l_sql = l_sql & " FROM empleado "
l_sql = l_sql & " INNER JOIN empleado revisor ON revisor.ternro = empleado.empreporta"
l_sql = l_sql & " INNER JOIN empleado super   ON super.ternro   = revisor.empreporta"

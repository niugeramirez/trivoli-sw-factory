...
' Orden
if ccodelco=-1 then
  l_Orden     = "N&uacute;mero:;Apellido:;Nombre:;Sigla:"
else
...
if (document.datos.selectape.value == 2){
	filtro= filtro + and + "empleado.terape = '"+escape(Blanquear(document.datos.apellido.value))+"'";
	and= " and ";
}
else 
	if (document.datos.selectape.value == 3){
	filtro= filtro + and + "empleado.terape like '"+escape(Blanquear(document.datos.apellido.value))+escape("%")+"'";
	and= " and ";
	} 

if (document.datos.selectnom.value == 2){
	filtro= filtro + and + "empleado.ternom = '"+escape(Blanquear(document.datos.nombre.value))+"'";
	and= " and ";
}
else 
	if (document.datos.selectnom.value == 3){
	filtro= filtro + and + "empleado.ternom like '"+escape(Blanquear(document.datos.nombre.value))+escape("%")+"'";
	and= " and ";
	} 
...
if (document.datos.selectdoc.value == 2){
	...
	if (document.datos.selectdocnro.value == 2){
		filtro= filtro + and + "ter_doc.nrodoc = '"+escape(Blanquear(document.datos.docnro.value))+"'";
		and= " and ";
	}
	else 
...
<table border="0" cellpadding="0" cellspacing="0">
  <tr style="border-color :CadetBlue;">
	<td colspan="2">
		<table border="0" cellpadding="0" cellspacing="0">
			<tr>
	        	<td align="left" class="barra">B&uacute;squeda de <%if ccodelco=-1 then%>Supervisados/Supervisores<%else%>Empleados<%end if%></td>
...
<tr>
	<td>
		<table width="100%">
			...
			<tr>
			    <td nowrap align="right"><b>N&uacute;mero:</b></td>
				<td>
...
<tr>
	<td colspan="2" >
  				<iframe name="ifrm" src="help_emp_02.asp?filtro=empleado.ternro=0" width="100%" height="170"></iframe> 
	</td>
</tr>
</table>

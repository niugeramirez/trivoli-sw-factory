...
<% 
'=====================================================================================
'Archivo  : historicas_eva_ag_00.asp
'Objetivo : Listados de formularios de evaluacion - cerrados o aprobados
'Fecha	  : 21-07-2004
'Autor	  : CCRossi 
'Modificado:  11/10/2005 - Leticia Amadio - Adecuarlo a autogestion
'		    18-08-2006 - LA. - Sacar la vista v_empleado
'           04-10-2006 - L.A. - incluir campo de código de evento en orden y filtro   
'=====================================================================================
on error goto 0

' Variables
' de parametros entrada
  Dim l_empleg   ' es el EMPLEG viene de autogestion o ....
...
<tr style="border-color :CadetBlue;" height="5%">
	<th colspan="2" align="left" class="th2"><%if ccodelco=-1 then%>Procesos <%else%>Formularios <%end if%>Hist&oacute;ricos de <%=l_nombre%></th>
</tr>
<tr height="5%">
	...
	<% end if%>
	&nbsp;
	<a class=sidebtnSHW href="Javascript:orden('/ess/ess/eval/historicas_eva_ag_01.asp');">Orden</a>
	<a class=sidebtnSHW href="Javascript:filtro('/ess/ess/eval/historicas_eva_ag_01.asp');">Filtro</a>
	&nbsp;
	</td>
</tr>
...
<tr valign="top" height="95%">
   <td colspan="3" style="">
   <iframe name="ifrm" src="historicas_eva_ag_01.asp?empleg=<%= request.querystring("empleg")%>" width="100%" height="100%"></iframe> 
   </td>
</tr>

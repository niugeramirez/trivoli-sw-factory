...
<!--
-----------------------------------------------------------------------------
Archivo        : noved_horarias_gti_05.asp
Descripcion    : Modulo que se encarga del alta masivo de nov horarias
Modificacion   :
    27/10/2003 - Scarpa D. - sacar la descripcion del tipo de novedad
...
' variables para seleccion multiple de emplados, para carga masiva de novedades
  dim l_listempleados
  dim l_veranterior

' var de parametro de entrada
  dim l_ternro
...
select Case l_tipo
	Case "A":
		...
		l_gnovdesabr = ""
		l_gnovdesext = ""
		l_gnovotoa = request.querystring("ternro")
		l_gtnovnro = ""
		l_motnro = ""
		l_gnovtipo = 1
		l_gnovdesde = ""
...
{
if (document.datos.listempleados.value == "") 
    alert("Debe seleccionar empleados.");
else	
...
if (document.datos.motnro.value == "") 
...
{
	document.datos.gpanro.disabled = document.datos.todos.checked;
}


//function CargarLista() 
//{
	//if (document.datos.veranterior.value == "0") {
		//document.datos.listempleados.value = "0," + document.datos.ternro.value ;
//	}
	//if (document.datos.veranterior.value == "1") {
		//document.datos.listempleados.value = "";
//	}

	//if (document.datos.veranterior.value == "2") {
		//document.datos.listempleados.value = "todos";
//	}
//}	    
function llamargengrup(){
	window.open('','vent_gengrup','toolbar=no,location=no,directories=no,satus=no,menubar=no,scrollbars=no,resizable=yes,width=480,height=430');
	document.gengrup.action ='gengrup_v3.asp?obj=document.datos.listempleados';
	document.gengrup.seleccion.value =  document.datos.listempleados.value;
	document.gengrup.submit();
}
...
<form name="gengrup" action="" target="vent_gengrup"  method="post">
<input type="Hidden" name="seleccion" value="">
</form>

<form name="datos" action="noved_horarias_gti_06.asp?tipo=<%= l_tipo %>&fechadesde=<%= l_fechadesde %>&fechahasta=<%= l_fechahasta %>" method="post">
...
<table cellspacing="0" cellpadding="0" border="0" width="100%" height="100%">
  <tr>
	...
	<td colspan="2" align="right" class="th2" valign="middle">
		&nbsp;&nbsp;&nbsp;
<a class=sidebtnSHW href="#" onclick="Javascript:llamargengrup()">Selecci&oacute;n de Empleados</a>&nbsp;
<!-- <a class=sidebtnHLP href="Javascript:ayuda('<%'= Request.ServerVariables("SCRIPT_NAME")%>');">Ayuda</a>  -->
	</td>
  </tr>
<tr>
    <td align="right"><br><b>Tipo de Novedad:</b></td>
	<td colspan="3">
	<br>
	<select name="gtnovnro" size="1" onchange="javascript:actualizarDescripcion();">
	<%	l_sql = "SELECT gtnovnro, gtnovdesabr "
		l_sql  = l_sql  & "FROM gti_tiponovedad WHERE gtnovest=-1 "
		l_rs.MaxRecords = 50
		rsOpen l_rs, cn, l_sql, 0
		do until l_rs.eof	 %>	
...
<tr>
	...
	<td colspan="3"><input type="text" name="gnovdesabr" size="35" maxlength="35" value="<%= l_gnovdesabr %>"></td>
</tr>
<tr>

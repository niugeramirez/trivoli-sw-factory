...
<%
	...
	'response.write arrData(0,2) & " - "  & arrData(1,2) & " - "  & arrData(3,2) & " - "  & arrData(4,2)
	'response.end
...
'		Call renderChart("../../FusionCharts/FCF_Column3D.swf", "", strXML, "productSales", 600, 400)
		Call renderChart("../FusionCharts/FCF_Pie2D.swf", "", strXML, "productSales", 600, 250)

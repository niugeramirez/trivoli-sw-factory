...
<title>Requerimientos - Capacitación - RHPro &reg;</title>
</head>
...
<script src="/rhprox2/shared/js/fn_numeros.js"></script>
<% 
			...
			<% End If %>
				...
				<tr>
					...
					<td  align="left" nowrap width="0">
						...
						<a href="Javascript:Ayuda_Fecha(document.datos.pedfecped)"><img src="/rhprox2/shared/images/cal.gif" border="0"></a>	
					</td>
					...
					<td  align="left" nowrap width="0">
						...
						<a href="Javascript:Ayuda_Fecha(document.datos.pedfecpret)"><img src="/rhprox2/shared/images/cal.gif" border="0"></a>	
					</td>
				</tr>
				<tr>

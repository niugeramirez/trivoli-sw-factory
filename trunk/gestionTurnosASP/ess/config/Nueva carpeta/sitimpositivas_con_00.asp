...
<% 
'Archivo: sitimpositivas_con_00.asp
'Descripción: Abm de Situaciones Imspositivas
...
function llamadaexcel(){ 
	if (filtro == "")
		...
		abrirVentana("sitimpositivas_con_excel.asp?orden=" + document.ifrm.datos.orden.value + "&filtro=" + escape(document.ifrm.datos.filtro.value),'execl',250,150);
}
...
<body leftmargin="0" topmargin="0" rightmargin="0" bottommargin="0">
      <table border="0" cellpadding="0" cellspacing="0" height="100%" width="100%">
        <tr style="border-color :CadetBlue;">
          <td align="left" class="barra">Situaciones Impositivas</td>
          <td nowrap align="right" class="barra">
          <a class=sidebtnABM href="Javascript:abrirVentanaVerif('sitimpositivas_con_02.asp?cabnro=' + document.ifrm.datos.cabnro.value,'',600,120);">Consulta</a>
		  &nbsp;&nbsp;
          <a class="sidebtnSHW" href="Javascript:llamadaexcel();">Excel</a>
		  &nbsp;&nbsp;
		  <a class=sidebtnSHW href="Javascript:orden('../../config/sitimpositivas_con_01.asp');">Orden</a>
		  <a class=sidebtnSHW href="Javascript:filtro('../../config/sitimpositivas_con_01.asp')">Filtro</a>
		  &nbsp;&nbsp;
        ...
        <tr valign="top" height="100%">
          <td colspan="2" style="" width="100%">
      	  <iframe name="ifrm" src="sitimpositivas_con_01.asp" width="100%" height="100%"></iframe> 
	      </td>
        </tr>

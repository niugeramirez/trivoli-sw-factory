...
<title>Formadores - Capacitación - RHPro &reg;</title>
...
<table border="0" cellpadding="0" cellspacing="0" height="100%">
	<tr>
	    <td nowrap align="left">
			...
			<img align="absmiddle" src="/rhprox2/shared/images/prev.jpg" alt="Empleado Anterior (<%= l_ant_leg %>)" border="0"></a>
			...
			<img align="absmiddle" src="/rhprox2/shared/images/next.jpg" alt="Empleado Siguiente (<%= l_sig_leg %>)" border="0"></a>
			...
			<img align="absmiddle" src="/rhprox2/shared/images/profile.gif" alt="Ayuda Empleados" border="0">
			</a>

...
<tr valign="top" style="border-bottom: 1px solid White;" nowrap id="66" onmouseover="TRPintar(this,'66');"  onmouseout="TRDesPintar(this,'66');"  onclick="ear(66,0);parent.datos.menunroant.value=parent.datos.menunro.value;parent.datos.menunro.value=66;">
	<td width="0" align="left" valign="middle"  nowrap style="background-color: Navy; color: white;"   > 
	
	<img title="No Obligatorio" src="../images/gen_rep/Obligno.gif"><a href="JavaScript:SigPaso('../../generacion/almuerzo_gen_00.asp',1,66);" class="plano" style="color:White" title="Incompleto" >Solicitud de Almuerzo</a><td width="10" style="background-color: Navy;border-left: 0px; border-bottom: 1px solid White; " valign="middle" align="left">&nbsp;</td>
  </tr>	

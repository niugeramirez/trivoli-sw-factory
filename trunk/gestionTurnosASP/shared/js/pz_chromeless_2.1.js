...
chromeTIThtml = chromeTIThtml + 
'	theURL="about:blank"                                                                                                                                                            '+ '\n'+
'	windowCERRARa 		= "../../../tablero//ticket/shared/images/close_a.gif"                                                                                                                                     '+ '\n'+
'	windowCERRARd 		= "../../../tablero//ticket/shared/images/close_d.gif"                                                                                                                                     '+ '\n'+
'	windowCERRARo 		= "../../../tablero//ticket/shared/images/close_o.gif"                                                                                                                                     '+ '\n'+
'	windowCLOCK         	= "../../../tablero//ticket/shared/images/clock.gif"                                                                                                                             		'+ '\n'+
...
'					                                                 												'+ '\n'+
'				if ( parent.chromemainloaded ) document.all["mywindowCLOCK"].style.visibility = "hidden";                                                 			'+ '\n'+
'					                                                 												'+ '\n'+
...
'generatetitle()																'+ '\n'+
'</script>																	'+ '\n'+
'<frameset border=0 framespacing=0 frameborder=0 rows="22,100%,1" onload="chromemainloaded=true" onreadystatechange="generatetitle()">		'+ '\n'+
...
'		<frame name=chromemain src="'+theURL+'" scrolling=no>                   									'+ '\n'+
